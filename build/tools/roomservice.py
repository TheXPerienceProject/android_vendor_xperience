...
if not depsonly:
    print("Device %s not found. Attempting to retrieve device repository from XPerience Github (http://github.com/TheXPerienceProject)." % device)
...
def get_default_revision():
    m = ElementTree.parse(".repo/manifests/xperience-default.xml")
...
def is_in_manifest(projectpath):
    ...
    # ... and don't forget the Xperience additions
    try:
        lm = ElementTree.parse(".repo/manifests/xpe-aosp.xml")
        lm = lm.getroot()
    except:
        lm = ElementTree.Element("manifest")
    ...
    try:
        lm = ElementTree.parse(".repo/manifests/caf.xml")
        lm = lm.getroot()
    except:
        lm = ElementTree.Element("manifest")
    ...
    try:
        lm = ElementTree.parse(".repo/manifests/xperience-default.xml")
        lm = lm.getroot()
    except:
        lm = ElementTree.Element("manifest")
...
def add_to_manifest(repositories, fallback_branch = None):
    ...
    for repository in repositories:
        ...
        print('Adding dependency: TheXPerienceProject/%s -> %s' % (repo_name, repo_target))
        project = ElementTree.Element("project", attrib = { "path": repo_target,
            "remote": repo_remote, "name": "TheXPerienceProject/%s" % repo_name })
