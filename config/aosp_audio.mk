...
# Copyright 2023 The XPerience Project
#
...
PRODUCT_COPY_FILES += \
    ...
    vendor/xperience_themes/audio/ui/WirelessChargingStarted.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/notifications/WirelessChargingStarted.ogg \
    vendor/xperience_themes/audio/ui/WirelessChargingStarted.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/WirelessChargingStarted.ogg \
    vendor/xperience_themes/audio/ui/camera_click.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/camera_click.ogg \
    vendor/xperience_themes/audio/ui/camera_focus.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/camera_focus.ogg \
    vendor/xperience_themes/audio/ui/camera_click.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/camera_click.ogg \
    vendor/xperience_themes/audio/ui/camera_focus.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/camera_focus.ogg \
    vendor/xperience_themes/audio/ui/ChargingStarted.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/ChargingStarted.ogg \
    vendor/xperience_themes/audio/ui/ChargingStarted.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/BatteryPlugged.ogg \
    vendor/xperience_themes/audio/ui/ChargingStarted.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/BatteryPlugged.ogg \
    vendor/xperience_themes/audio/ui/Effect_Tick.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/Effect_Tick.ogg \
    vendor/xperience_themes/audio/ui/Effect_Tick.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/Effect_Tick.ogg \
    vendor/xperience_themes/audio/ui/Lock.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/Lock.ogg \
    vendor/xperience_themes/audio/ui/Lock.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/Lock.ogg \
    vendor/xperience_themes/audio/ui/LowBattery.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/LowBattery.ogg \
    vendor/xperience_themes/audio/ui/LowBattery.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/LowBattery.ogg \
    vendor/xperience_themes/audio/ui/Unlock.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ui/Unlock.ogg \
    vendor/xperience_themes/audio/ui/Unlock.ogg:$(TARGET_COPY_OUT_SYSTEM)/media/audio/ui/Unlock.ogg
